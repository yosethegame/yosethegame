...
describe('Feedback response matcher when #info class still contains hidden after a ship is docked,', function() {
	...
	it('sets expected', function() {
		expect(status.expected).toContain("#info class should not contain 'hidden' after a ship is docked");
	});

	it('sets actual', function() {
		expect(status.got).toEqual("Error: #info has class 'hidden'");
	});                
});