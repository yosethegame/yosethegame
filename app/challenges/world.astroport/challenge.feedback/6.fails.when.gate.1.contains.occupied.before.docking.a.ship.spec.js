...
describe('Feedback response matcher when gate-1 contains occupied before docking a ship,', function() {
    ...
    beforeEach(function(done) {
        content = '<html><body>' +
                        '<div id="gate-1" class="free occupied">' +
	...
	it('sets actual', function() {
		expect(status.got).toEqual("Error: #gate-1 has class 'occupied' before docking");
	});                
});