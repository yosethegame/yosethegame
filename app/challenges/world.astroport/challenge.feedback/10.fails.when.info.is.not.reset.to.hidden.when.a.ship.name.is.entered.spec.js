...
describe('Feedback response matcher when #info class is not reset to hidden when a ship name is entered again,', function() {
	...
	it('sets expected', function() {
		expect(status.expected).toContain("#info class should contain 'hidden' when a ship is entered again");
	});

	it('sets actual', function() {
		expect(status.got).toEqual("Error: #info has class 'anything'");
	});                
});