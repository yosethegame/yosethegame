...
describe('Persistence matcher,', function() {
    ...
    describe('When server displays exactly the expected last decomposition,', function() {
    ...
    describe('When server displays the expected last decomposition,', function() {
        ...
        beforeEach(function() {
            ...
            decomposition = '<html><body>' +
                '<input id="number" />' +
                '<button id="go" />' +
                '<label id="last-decomposition">anything before 42 = 2 x 3 x 7 anything after</label>' +
                '</body></html>';
            remote = require('http').createServer(function (request, response) {
                response.write(decomposition);
                response.end();
